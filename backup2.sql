...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 05, 2023 at 07:17 PM
...
(1, NULL, 'Joshua', 'Mislang', '09898113131', 'Male', 'Worker', '../assets/emp_pic/mislang.jpg'),
(2, NULL, 'Mark', 'Zucker', '09949494946', 'Male', 'Worker', '../assets/images/no_img.jpg'),
(3, NULL, 'Jared', 'Dillinger', '09594640643', 'Male', 'Foreman', '../assets/images/no_img.jpg'),
(4, NULL, 'Gerald', 'Underscore', '09594456464', 'Male', 'Worker', '../assets/images/no_img.jpg'),
(5, NULL, 'Coco', 'Maja', '09894949405', 'Male', 'Worker', '../assets/images/no_img.jpg'),
(6, NULL, 'Sam', 'Misth', '08948440949', 'Male', 'Worker', '../assets/images/no_img.jpg'),
(7, NULL, 'Ryan ', 'Owen', '09942549529', 'Male', 'Engineer', '../assets/images/no_img.jpg'),
...
(10, NULL, 'Joshua', 'Langmis', '09095495095', 'Male', 'Foreman', '../assets/images/no_img.jpg'),
(11, NULL, 'Ivana', 'Mulawin', '09594064644', 'Female', 'Human Resource', '../assets/images/no_img.jpg'),
(12, NULL, 'Kevin', 'Caezar', '09987165010', 'Male', 'Engineer', '../assets/images/no_img.jpg'),
...
(15, NULL, 'Jhong', 'Hillario', '09589449494', 'Male', 'Worker', '../assets/images/no_img.jpg'),
(16, NULL, 'Donny', 'Narcos', '09898090449', 'Male', 'Worker', '../assets/images/no_img.jpg'),
(17, NULL, 'Mariel', 'Santos', '09097644646', 'Female', 'Human Resource', '../assets/images/no_img.jpg'),
(18, NULL, 'Bryan', 'Aguilar', '09744946464', 'Male', 'Worker', '../assets/images/no_img.jpg'),
...
ALTER TABLE `covered court`
  ADD PRIMARY KEY (`ID`),
  ADD KEY `courtProjectID` (`projectID`);
...
ALTER TABLE `hauling transport`
  ADD PRIMARY KEY (`ID`),
  ADD KEY `haulingProjectID` (`projectID`);
...
ALTER TABLE `house/building`
  ADD PRIMARY KEY (`ID`),
  ADD KEY `houseProjectID` (`projectID`);
...
ALTER TABLE `materials`
  ADD PRIMARY KEY (`ID`),
  ADD KEY `materialProjecID` (`projectID`);
...
ALTER TABLE `road/highway`
  ADD PRIMARY KEY (`ID`),
  ADD KEY `roadProjectID` (`projectID`);
...
ALTER TABLE `team`
  ADD PRIMARY KEY (`ID`),
  ADD KEY `teamProjectID` (`projectID`);
...
--
-- Constraints for table `covered court`
--
ALTER TABLE `covered court`
  ADD CONSTRAINT `courtProjectID` FOREIGN KEY (`projectID`) REFERENCES `project` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
-- Constraints for table `hauling transport`
--
ALTER TABLE `hauling transport`
  ADD CONSTRAINT `haulingProjectID` FOREIGN KEY (`projectID`) REFERENCES `project` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `house/building`
--
ALTER TABLE `house/building`
  ADD CONSTRAINT `houseProjectID` FOREIGN KEY (`projectID`) REFERENCES `project` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `materials`
--
ALTER TABLE `materials`
  ADD CONSTRAINT `materialProjecID` FOREIGN KEY (`projectID`) REFERENCES `project` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `project`
--
ALTER TABLE `project`
  ADD CONSTRAINT `projectTeamID` FOREIGN KEY (`teamID`) REFERENCES `team` (`ID`);

--
-- Constraints for table `road/highway`
--
ALTER TABLE `road/highway`
  ADD CONSTRAINT `roadProjectID` FOREIGN KEY (`projectID`) REFERENCES `project` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `team`
--
ALTER TABLE `team`
  ADD CONSTRAINT `teamProjectID` FOREIGN KEY (`projectID`) REFERENCES `project` (`ID`) ON DELETE SET NULL ON UPDATE SET NULL;
COMMIT;
