                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button type="button" class="popover" data-bs-toggle="modal" data-bs-target="#done<?php echo $row['ID']; ?>"><i class="fas fa-circle-check fa-2xl" style="color: #35f500;"></i></button>
